...
function Column({ column }) {
  ...
  const columnCards = Object.values(cards).filter(card => card.columnId === column.id);

  return (
    <div className="bg-card-glass rounded-xl p-4 min-w-[250px] shadow-card flex flex-col">
